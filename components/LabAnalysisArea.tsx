    ...
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <div className="relative">
          <textarea id="lab-results" rows={5} className="w-full bg-slate-900 border border-slate-600 rounded-xl p-4 text-gray-200 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-colors placeholder-gray-500" placeholder="مثال:&#10;CBC&#10;Hemoglobin: 14.5 g/dL&#10;WBC: 7.2 x 10^9/L&#10;..." value={labText} onChange={(e) => setLabText(e.target.value)} />
        </div>
      </div>
