  ...
  useEffect(() => {
    ...
    if (SpeechRecognition) {
      ...
      recognition.onresult = (event) => {
        ...
        setMedicationText(prev => prev + finalTranscript);
      };
    ...
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <div className="relative">
          <textarea id="medication" rows={3} className="w-full bg-slate-900 border border-slate-600 rounded-xl p-4 text-gray-200 focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 transition-colors placeholder-gray-500" placeholder="اكتب اسم الدواء هنا..." value={medicationText} onChange={(e) => setMedicationText(e.target.value)} />
